...
Shader "Multi Uvs"
{
	Properties
	{
		...
		[ASEBegin]_TextureUV4("Texture (UV1)", 2D) = "white" {}
		_TextureUV5("Texture (UV2)", 2D) = "white" {}
		_TextureUV6("Texture (UV3)", 2D) = "white" {}
		_NormalMap1("NormalMap", 2D) = "bump" {}
		_metal1("metal", Range( 0 , 1)) = 0
		_smooth1("smooth", Range( 0 , 1)) = 0
		_uv4("uv2", Range( 0 , 1)) = 0
		[ASEEnd]_uv5("uv3", Range( 0 , 1)) = 0
	...
	SubShader
	{
		...
		Pass
		{
			...
			float4 _TextureUV4_ST;
			float4 _TextureUV5_ST;
			float4 _TextureUV6_ST;
			...
			#endif
			CBUFFER_END
			sampler2D _TextureUV4;
			sampler2D _TextureUV5;
			sampler2D _TextureUV6;
						 ...
						 ) : SV_Target
			{
				...
				float2 uv_TextureUV4 = IN.ase_texcoord7.xy * _TextureUV4_ST.xy + _TextureUV4_ST.zw;
				float2 uv2_TextureUV5 = IN.ase_texcoord7.zw * _TextureUV5_ST.xy + _TextureUV5_ST.zw;
				float4 lerpResult19 = lerp( tex2D( _TextureUV4, uv_TextureUV4 ) , tex2D( _TextureUV5, uv2_TextureUV5 ) , _uv4);
				float2 uv3_TextureUV6 = IN.ase_texcoord8.xy * _TextureUV6_ST.xy + _TextureUV6_ST.zw;
				float4 lerpResult20 = lerp( lerpResult19 , tex2D( _TextureUV6, uv3_TextureUV6 ) , _uv5);
				...
				float3 Emission = 0;
				float3 Specular = 0.5;
				float Metallic = _metal1;
				float Smoothness = _smooth1;
				float Occlusion = 1;
				float Alpha = 1;
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float2 uv_TextureUV4 = IN.ase_texcoord2.xy * _TextureUV4_ST.xy + _TextureUV4_ST.zw;
				float2 uv2_TextureUV5 = IN.ase_texcoord2.zw * _TextureUV5_ST.xy + _TextureUV5_ST.zw;
				float4 lerpResult19 = lerp( tex2D( _TextureUV4, uv_TextureUV4 ) , tex2D( _TextureUV5, uv2_TextureUV5 ) , _uv4);
				float2 uv3_TextureUV6 = IN.ase_texcoord3.xy * _TextureUV6_ST.xy + _TextureUV6_ST.zw;
				float4 lerpResult20 = lerp( lerpResult19 , tex2D( _TextureUV6, uv3_TextureUV6 ) , _uv5);
...
/*ASEBEGIN
Version=18900
0;0;1920;1019;3756.687;990.9668;2.402221;True;False
Node;AmplifyShaderEditor.SamplerNode;17;-1130.791,-139.6828;Inherit;True;Property;_TextureUV5;Texture (UV2);1;0;Create;True;0;0;0;False;0;False;-1;None;None;True;1;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;16;-1113.715,67.99963;Float;False;Property;_uv4;uv2;6;0;Create;True;0;0;0;False;0;False;0;1;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;15;-1109.268,-341.0782;Inherit;True;Property;_TextureUV4;Texture (UV1);0;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;21;-780.1882,285.7437;Float;False;Property;_uv5;uv3;7;0;Create;True;0;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.LerpOp;19;-741.8483,-219.2317;Inherit;True;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.SamplerNode;18;-812.7472,73.14185;Inherit;True;Property;_TextureUV6;Texture (UV3);2;0;Create;True;0;0;0;False;0;False;-1;None;None;True;2;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.LerpOp;20;-368.6522,-74.74194;Inherit;True;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.SamplerNode;12;-413.4171,-363.7147;Inherit;True;Property;_NormalMap1;NormalMap;3;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;True;bump;Auto;True;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;14;-370.8614,272.8196;Float;False;Property;_smooth1;smooth;5;0;Create;True;0;0;0;False;0;False;0;1;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;13;-372.3087,174.3924;Float;False;Property;_metal1;metal;4;0;Create;True;0;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=B8BC15E8D3F37593BA2ADE4B9FB64E5C69F685B3